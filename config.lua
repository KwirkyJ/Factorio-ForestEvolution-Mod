...
config.seed_location_search_tries = 6
...
config.tree_tile_ore_modifiers = {
    mast = 1, spawn = 0.3, death = 1, decay = 0.7
}

config.tree_names_live = {
    "tree-01",
    "tree-02",
    "tree-02-red",
    "tree-03",
